...
[![Status: Production Ready](https://img.shields.io/badge/status-production_ready-green)]()
...
### Основное
- ✅ Добавление inline-кнопки «Комментарии» под каждым постом канала
- ✅ Полноценный чат комментариев внутри мини-приложения
- ✅ Реальный времени через SSE с fallback на polling
- ✅ Валидация пользователей через initData (HMAC-SHA256)
- ✅ Доступ только для подписчиков канала

### Комментарии
- ✅ Отправка комментариев с поддержкой многострочного ввода
- ✅ Ответы на комментарии (threaded replies)
- ✅ Автоматическая синхронизация участников канала
- ✅ Отображение автора и времени комментария

### Реакции
- ✅ 6+ реакций на комментарии (👍, ❤️, 😂, 🔥, 😢, 😮, и другие)
- ✅ Долгий тап (мобильные) / правый клик (ПК) для выбора реакции
- ✅ Отображение количества реакций под комментарием
- ✅ Обновление реакций в реальном времени через SSE
- ✅ Визуальная анимация при нажатии на реакцию

### Пост в мини-приложении
- ✅ Отображение текста поста в шапке комментариев
- ✅ Отображение фото из поста (с поддержкой нескольких изображений)
- ✅ Сворачивание/разворачивание длинного текста поста
- ✅ Автоматическое подтягивание названия канала из MAX API
- ✅ Поддержка космической темы оформления (как в оригинальном MAX)

### UI/UX
- ✅ Космический фон с парящими звёздами, ракетами и планетами
- ✅ Прозрачные элементы с эффектом размытия (glassmorphism)
- ✅ Поддержка светлой и тёмной темы (через CSS переменные)
- ✅ Адаптивный дизайн для мобильных устройств
- ✅ Анимированные всплывающие эмодзи при нажатии на реакцию
- ✅ Плавные анимации и переходы
- ✅ Кастомный скроллбар

### Технические особенности
- ✅ Автоматическое определение аватарки и названия канала
- ✅ Поддержка всех типов вложений (фото, видео)
- ✅ Валидация initData с проверкой подписи
- ✅ Защита от XSS через экранирование
- ✅ Graceful fallback SSE → polling при проблемах с соединением
- ✅ Полная изоляция в Docker с Traefik
- ✅ Автоматический SSL через Let's Encrypt

## ⚠️ Статус проекта

> Проект **работоспособен и готов к использованию** в production-среде.
> 
> Все основные функции реализованы и протестированы. Поддерживается на канале "Столярная мастерская Аксёнова".
...
**1.** Просмотр списка пользователей, поставивших реакцию

**2.** Уведомления о новых комментариях

**3.** Редактирование/удаление комментариев

**4.** Модерация комментариев

**4.** Поддержка видео в мини-приложении (через iframe)